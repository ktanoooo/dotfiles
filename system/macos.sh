...
ExtraSettings() {
  ...
  # ========== Set Computer Name ==========
  # !!!!! This should not be set !!!!!
  # sudo scutil --set HostName "ktanoooo"
  # sudo scutil --set ComputerName "ktanoooo"
  # sudo scutil --set LocalHostName "ktanoooo"
  # sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "ktanoooo"
